...
myargs=()
#Variables to identify the state of the input
vebosevarm1=0
debugvarm1=0
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  #Moving the command line argument to process
  shift
...
#If condition to check state of the variables
if [ $vebosevarm1 = 1 ]; then
...
# Print out the myargs array with a label
#If condition to check state of the variables
if [ $debugvarm1 -gt 0 ]; then
  echo "Debug Mode is On with debug level $debugvarm1."
else
