...
# creating new directory name as picture if there's nothing
...
# downloading tarfile into picture directory  if it is not there
...
# unpack the downloaded tarfile if it is there, then delete the local copy of the tar file
